...
-- clr.text = clr.burned
clr.keyword = clr.blue
clr.string = clr.yellow
...
clr.property = clr.burned
clr.variable = clr.burned
-- clr.keyword = clr.yellow_light_2
-- clr.string = clr.burn_red
-- clr.text = "#dcdccc"
...
local theme = lush(function(injected_functions)
  ...
  local result = {
    ...
    Comment { fg = clr.comment }, -- Any comment

    -- Constant       { }, -- (*) Any constant
    String { fg = clr.string }, --   A string constant: "this is a string"
    -- Character      { }, --   A character constant: 'c', '\n'
    Number { fg = clr.number }, --   A number constant: 234, 0xff
    ...
    DiagnosticWarn { fg = clr.yellow }, -- Used as the base highlight group. Other Diagnostic highlights link to this by default (except Underline)
    ...
    -- TelescopeResultsBorder     { fg = clr.bg_darker2, bg = clr.bg_darker2  },
    TelescopeNormal            { bg = clr.bg_darker                        },
    TelescopePreviewTitle      { fg = clr.bg,         bg = clr.green_light },
    TelescopePromptTitle       { fg = clr.bg,         bg = clr.yellow  },
    TelescopeSelection         { bg = clr.bg_darker2, fg = clr.green_light },
    ...
    WhichKeyDesc      { fg = clr.burn_white_2 },
    ...
    sym'@String'         { fg = clr.string  },
    sym'@variable'       { Normal           },
    sym'@type.builtin'   { fg = clr.type    },
    sym'@keyword.import' { Normal           },
    sym'@keyword.repeat' { Keyword },
    sym'@string.escape'  { fg = clr.yellow_light_2  },

    -- cpp
    sym'@namespace.cpp'                { fg = clr.text     },
    sym'@function.cpp'                 { fg = clr.func     },
    ...
    sym'@variable.cpp'                 { fg = clr.variable },
    sym'@operator.cpp'                 { fg = clr.text2    },
    sym'@character.cpp'                { fg = clr.string   },
    sym'Structure'                     { fg = clr.type     },
    sym'@lsp.type.class.cpp'           { fg = clr.type     },
    sym'@lsp.typemod.enum.deduced.cpp' { fg = clr.type     },
    sym'@lsp.type.namespace.cpp'       { fg = clr.type     },
    sym'@lsp.type.macro.cpp'           { fg = clr.macro    },
    sym'@lsp.type.property.cpp'        { fg = clr.property },
    sym'@lsp.mod.constructorOrDestructor.cpp' { Function },
    -- sym'@lsp.mod.classScope.cpp' { fg = clr.red },
    -- sym'@lsp.type.function.cpp'        { fg = clr.red },
    -- sym'@lsp'      { fg = color.red },
    ...
    CmpItemKindDefault           { fg = clr.burn_red                     },
    CmpItemKind                  { CmpItemKindDefault                    },
    CmpItemKindType              { CmpItemKindDefault                    },
    CmpItemKindTabNine           { CmpItemKindDefault                    },
    CmpItemKindSnippet           { CmpItemKindDefault                    },
    CmpItemKindModule            { CmpItemKindDefault                    },
    CmpItemKindUnit              { fg = '#9acfd6'                        },
    CmpItemKindFolder            { fg = clr.burned                       },
    CmpItemKindFile              { fg = clr.burned                       },
    CmpItemKindKeyword           { fg = clr.burned                       },
    ...
    CmpItemKindVariable          { fg =  clr.blue_darker },
    CmpItemKindConstructor       { fg = '#6f8dab'                        },
    CmpItemKindStruct            { fg = clr.blue_darker                  },
    CmpItemKindText              { fg = '#d69545'                        },
    CmpItemKindConstant          { fg = clr.macro                        },
    CmpItemKindEvent             { fg = '#d7bd8d'                        },
    CmpItemKindReference         { fg = clr.burn_white_2                 },
    CmpItemKindTypeParameter     { fg = clr.burn_white_2                 },
    CmpItemKindOperator          { fg = clr.burn_white_2                 },
    CmpItemKindMethod            { fg = clr.burn_white_2                 },
    CmpItemKindField             { fg = clr.burn_white_2                 },
    CmpItemKindProperty          { fg = clr.burn_white_2                 },
    CmpItemKindIdentifier        { fg = clr.burn_white_2                 },
    CmpItemKindFunction          { fg = clr.burn_white_2                 },
    ...
    BufferLineModifiedSelected { bg = "#2e2f30", fg = clr.yellow },
